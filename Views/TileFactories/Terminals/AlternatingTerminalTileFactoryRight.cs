...
{
    public class AlternatingTerminalTileFactoryRight : MonoBehaviour
    {
        [SerializeField] private AlternatingTerminalTileRight prefabAlternatingTerminalTileRight;
        [SerializeField] private int preloadTerminalTileCount;

        private readonly Dictionary<int, AlternatingTerminalTileRight> _terminalTiles = new();
        private ObjectPool<AlternatingTerminalTileRight> _objectPoolTerminalTiles;

        private void Awake()
        {
            _objectPoolTerminalTiles = new ObjectPool<AlternatingTerminalTileRight>(() => Instantiate(prefabAlternatingTerminalTileRight, transform),
        ...
        private void Start()
        {
            var preloadedTerminalTiles = new List<AlternatingTerminalTileRight>();
        ...
        public AlternatingTerminalTileRight Generate(int tileId)
        {
