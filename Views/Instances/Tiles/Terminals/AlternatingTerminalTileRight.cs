...
{
    public class AlternatingTerminalTileRight : TileBase, IMovableTile, IRenderableTile, ITerminalTile
    {
        ...
        private void Start()
        {
            ...
            meshRendererTerminalSymbol.material.SetFloat(_idleHue, electricParams.GetHue(ElectricStatus.Alternating));
        }
