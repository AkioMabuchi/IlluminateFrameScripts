...
{
    public class AlternatingPowerTile : TileBase, IMovableTile, IRenderableTile
    {
        ...
        private void Start()
        {
            ...
            meshRendererPowerSymbol.material.SetFloat(_idleHue, electricParams.GetHue(ElectricStatus.Alternating));
            meshRendererPowerSymbol.material.SetFloat(_emissionHue, electricParams.GetHue(ElectricStatus.Alternating));
            meshRendererPowerSymbol.material.SetFloat(_radiantEmissionHue,
                electricParams.GetHue(ElectricStatus.Alternating));
        }
        ...
        public void RenderIlluminate(LineDirection lineDirectionIn, LineDirection lineDirectionOut)
        {
            switch (lineDirectionOut)
            {
                ...
                {
                    meshRendererLineB.material = electricMaterials.GetIlluminatedMaterial(_electricStatusLineA);
                    break;
                }
                case LineDirection.Down:
                {
                    meshRendererLineA.material = electricMaterials.GetIlluminatedMaterial(_electricStatusLineB);
                    break;
                }
            }
