...
{
    public class MinusPowerTile : TileBase, IMovableTile, IRenderableTile
    {
        ...
        private void Start()
        {
            ...
            meshRendererPowerSymbol.material.SetFloat(_idleHue, electricParams.GetHue(ElectricStatus.Minus));
            meshRendererPowerSymbol.material.SetFloat(_emissionHue, electricParams.GetHue(ElectricStatus.Minus));
            meshRendererPowerSymbol.material.SetFloat(_radiantEmissionHue, electricParams.GetHue(ElectricStatus.Minus));
        }
        ...
        public void RenderDarken(IEnumerable<ElectricStatus> electricStatuses)
        {
            ...
            if (hashSetElectricStatuses.Contains(ElectricStatus.Minus))
            {
