...
{
    public class ThreeWayDistributorTile : TileBase, IMovableTile, IRenderableTile, IRotatableTile, IThrowableTile
    {
            ...
            switch (_rotateStatus)
            {
                case RotateStatus.Rotate0:
                {
                    switch (lineDirectionIn)
                    {
                        case LineDirection.Left:
                        {
                            meshRendererLineA.material =
                                electricMaterials.GetShortedMaterial(shortedStatus);
                            break;
                        }
                        case LineDirection.Down:
                        {
                            meshRendererLineB.material =
                                electricMaterials.GetShortedMaterial(shortedStatus);
                            break;
                        }
                        case LineDirection.Right:
                        {
                            meshRendererLineC.material =
                                electricMaterials.GetShortedMaterial(shortedStatus);
                            break;
                        }
                    }
