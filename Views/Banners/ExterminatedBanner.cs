...
namespace Views.Banners
{
    ...
    public class ExterminatedBanner : MonoBehaviour
    {
        ...
        {
            textMeshProMain.text = localizer.CurrentLocale.ExterminatedBannerMain;
        }
        ...
        public void ShowUp()
        {
            DOTween.Sequence()
                ...
                ).Append(DOTween.To(() => _currentAlphaLines = 0.0f, value => { _currentAlphaLines = value; }, 1.0f,
                        durationFadeInLines)
