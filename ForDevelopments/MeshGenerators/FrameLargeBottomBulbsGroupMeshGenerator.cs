...
{
    public class FrameLargeBottomBulbsGroupMeshGenerator : MonoBehaviour
    {
        private struct Akio
        {
        ...
        [SerializeField] private float pitchPositionX;
        ...
        private void GenerateMesh()
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                var right = size.x * 0.5f + startPositionX + pitchPositionX * i;
                var left = size.x * 0.5f - size.x + startPositionX + pitchPositionX * i;
