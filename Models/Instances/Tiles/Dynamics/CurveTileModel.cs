...
{
    public class CurveTileModel : TileModelBase, IResettableTileModel, ICheckableValidTileModel,
        ITileModel, IRotatableTileModel, IConductiveTileModel, IRadiantTileModel
    {
        ...
        public CurveTileModel()
        {
            
        }

        private CurveTileModel(CurveTileModel curveTileModel)
        {
            _reactivePropertyRotateStatus.Value = curveTileModel._reactivePropertyRotateStatus.Value;
            _reactivePropertyElectricStatusLine.Value = curveTileModel._reactivePropertyElectricStatusLine.Value;
        }
        public void Reset()
        {
        ...
        public IConductiveTileModel DuplicatedConductiveTileModel => new CurveTileModel(this);
